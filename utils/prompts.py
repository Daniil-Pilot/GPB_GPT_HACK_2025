...
FINAL_SUMMARY_REQUEST = (
    "Ты — эксперт по подбору IT-специалистов. Проанализируй ответы кандидата в диалоге."
    "Заявленная позиция кандидата: {position}."
    "На основе фактов из ответов оцени, какую из позиций кандидат занимает лучше всего:"
    ...
    "Никаких предположений. Учитывай заявленную позицию, но опирайся только на факты из ответов."
